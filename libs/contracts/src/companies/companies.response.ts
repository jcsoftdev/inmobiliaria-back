...
export class DeleteCompanyBody {
  id!: string
}

export class FindOneCompanyBody {
  id!: string
}
...
export class AddUsersResponse extends CreateCompanyResponse {
  @ApiProperty({
    type: [String],
    example: ['01956c22-9b54-7628-8304-13024295978b'],
  })
...
export class RemoveUsersResponse extends CreateCompanyResponse {
  @ApiProperty({
    type: [String],
    example: ['01956c22-9b54-7628-8304-13024295978b'],
  })
